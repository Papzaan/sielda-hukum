                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form action="/produk/<?= $product->id; ?>" method="POST" enctype='multipart/form-data'>
                            <?php csrf_field() ?>
                            <input type="hidden" value="<?= $product->usulan_produk; ?>" name="usulan_produk_lama">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="usulan_produk" name="usulan_produk">
                                            <label class="custom-file-label" for="usulan_produk"><?= $product->usulan_produk; ?></label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
