...
<body class="hold-transition login-page">
    ...
    $username = $session->getFlashdata('nip');
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                ...
                <img src="<?php base_url(); ?>/assets/img/Lambang_Kabupaten_Pringsewu.png" alt="sielda" class=" elevation-3" width="50" height="60px" style="">
                <img src="<?php base_url(); ?>/assets/img/logo-sielda.jpeg" alt="sielda" class=" elevation-3" width="230" height="50px" style="">
